...
class DailyAttendance(models.Model):
    ...
    user_id = fields.Boolean('List all Employees', required=True)
    ...
    total_student = fields.Integer(compute="_compute_total", store=True, help="Total Employees", string='Total Employees')
...
class DailyAttendanceLine(models.Model):
    ...
    emp_id = fields.Many2one('daily.attendance', 'Employee')
